...
const Calculator = {
    ...
    First_Operand: null,
    // this checkwhether or not the second operand has been input
    Wait_Second_Operand: false,
    // this will hold the operator, we set it to null for now
    operator: null,
};

// this modifies values each tiume a button is clicked
...
function Input_Decimal(dot) {
    ...
    // doesn't cause bugs in your opertation
...
function Handle_Operator(Next_Operator) {
    ...
    // check if an operator already exists and if Wait_Seccond_Operand is true,
...
// this functin updates the screen with the contents of Display_Value
...
Update_Display();
// this section monitos button clicks
const keys = document.querySelector('.calculator-keys');
keys.addEventListener('click', (event) => {
// the targer variable is an object taht represent the element
// that was clicked
const { target } = event;
//if the element that was clicked on is not a button, exit from function
